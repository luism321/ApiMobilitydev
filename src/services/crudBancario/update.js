...
router.post(routes.updateBancos, verifyToken, async (req, res) => {
                    ...
                    .get().then((doc) => {
                        ...
                        db.collection("Usuarios").doc(uid)
                            .update(
                                ...
                                res.json({
                                    mensaje: "dato bancario actualizado con éxito",
                                })
                            }).catch((error) => {
                                res.send({ msg: false, text: 'No se pudo actualizar dato bancario', error: error.message })
                            })
